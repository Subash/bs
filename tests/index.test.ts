...
test.only('toBikramSambat()', () => {
  expect(toBikramSambat({ year: 1893, month: 4, day: 12 })).toEqual({ year: 1950, month: 1, day: 1 });
  expect(toBikramSambat({ year: 1893, month: 4, day: 13 })).toEqual({ year: 1950, month: 1, day: 2 });
...
test.only('toCommonEra()', () => {
  expect(toCommonEra({ year: 1950, month: 1, day: 1 })).toEqual({ year: 1893, month: 4, day: 12 });
