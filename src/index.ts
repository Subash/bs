...
export function toBikramSambat({ day, month, year }: CommonEra): BikramSambat {
  ...
  for (let [monthIndex, monthDays] of CALENDAR_MONTHS.entries()) {
...
export function toCommonEra({ year, month, day }: BikramSambat): CommonEra {
